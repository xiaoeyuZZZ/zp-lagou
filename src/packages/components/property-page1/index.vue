    ...
    <div class="property-page">
        <el-form :model="ruleFrom" label-width="100">
            <div class="property-line">
                ...
                <el-form-item label="数据显示切换  :">
                    <el-switch v-model="ruleFrom.isExchangeDisplay" active-text="是" inactive-text="否"></el-switch>
                </el-form-item>
            </div>
            ...
            <el-form-item label="设置切换时间(多选)  :">
                <el-checkbox-group v-model="ruleFrom.setSwitchingTime">
                    <el-checkbox label="今天"></el-checkbox>
                    <el-checkbox label="本月"></el-checkbox>
                    <el-checkbox label="本季度"></el-checkbox>
                    <el-checkbox label="本年"></el-checkbox>
                </el-checkbox-group>
            </el-form-item>
            <el-form-item label="切换时间  :">
                <el-radio v-model="ruleFrom.switchTime" label="1">10s</el-radio>
                <el-radio v-model="ruleFrom.switchTime" label="2">20s</el-radio>
                <el-radio v-model="ruleFrom.switchTime" label="3">30s</el-radio>
                <el-radio v-model="ruleFrom.switchTime" label="4">其他</el-radio>
            </el-form-item>
            <el-form-item label="大屏显示时间 :">
                <div class="property-page-bottom">
                    <div>
                        ...
                        <el-date-picker v-model="ruleFrom.screenDate" align="right" type="date"
...
<style scoped>
    ...
    .property-line .el-form-item--small.el-form-item {
        width: 230px;
    }
